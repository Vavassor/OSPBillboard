Shader "Orchid Seal/OSP Billboard/Distance Field Billboard"
{
    ...
    // Tweaked by Jonah
    // https://gist.github.com/JonahGrimm/ed91a0b9e61604e86fc2a403c9f3ee08
    ...
    Properties
    {
        ...
        [NoScaleOffset] _Cube("Reflection Cubemap", Cube) = "black" { /* TexGen CubeReflect */ }
        ...
        [Enum(Inner Bevel,0,Outer Bevel,1)] _ShaderFlags("Flags", float) = 0
        ...
        _Sharpness("Sharpness", Range(-1, 1)) = 0.5
        ...
        _SilhouetteFadeAlpha("Silhouette Fade Alpha", Range(0, 1)) = 0.3
    ...
    SubShader
    {
        ...
        pixel_t VertShader(vertex_t input)
        {
            ...
            scale *= abs(input.texcoord1.y) * _GradientScale * (_Sharpness + 1) * pixelConstantScale;
            ...
            #if DISTANCE_FADE_ON
            output.distanceFade = lerp(_DistanceFadeMinAlpha, _DistanceFadeMaxAlpha, smoothstep(_DistanceFadeMin, _DistanceFadeMax, centerViewDistanceWs));
            #endif
            #if (UNDERLAY_ON || UNDERLAY_INNER)
        ...
        fixed4 PixShader(pixel_t input) : SV_Target
        {
            ...
            fixed4 finalColor = faceColor * input.color.a;
                ...
                finalColor *= _SilhouetteFadeAlpha;
            #endif

            #if DISTANCE_FADE_ON
                finalColor *= input.distanceFade;
            #endif
    ...
    CustomEditor "OrchidSeal.Billboard.Editor.TmpSdfBillboardEditor"
}
